...
class BaiduMapViewController: UIViewController, BMKMapViewDelegate, BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate {
    let myBundle = NSBundle(path: "baidumap.bundle")
    ...
    func mark(sender: AnyObject) {
        ...
        markBtn.setBackgroundImage(UIImage(named: "dtbz_btn_mark.png"), forState: .Normal)
...
//                locationService.startUserLocationService()
        ...
        if nil != self.longitude && self.longitude > 0 {
            self.markBtn.setBackgroundImage(UIImage(named: "dtbz_btn_mark.png"), forState: .Normal)
        }
    ...
    func initViews(){
        ...
        closeButton.setBackgroundImage(UIImage(named: "nav_back.png"), forState: UIControlState.Normal)
        ...
        locButton.setBackgroundImage(UIImage(named: "dtbz_btn_remark.png"), forState: UIControlState.Normal)
        ...
        zoomOut.setBackgroundImage(UIImage(named: "dtbz_btn_zoom_out.png"), forState: UIControlState.Normal)
        ...
        zoomIn.setBackgroundImage(UIImage(named: "dtbz_btn_zoom_in.png"), forState: UIControlState.Normal)
        ...
        let markImage = UIImageView(image: UIImage(named: "dtbz_icon_location.png"))
